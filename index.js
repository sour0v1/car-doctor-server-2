...
// middleware
app.use(cors({
    origin: ['http://localhost:5176', 'http://localhost:5175', 'http://localhost:5174', 'http://localhost:5173', 'https://car-doctor-client-01.web.app', 'https://car-doctor-client-01.firebaseapp.com'],
    credentials: true
}));
